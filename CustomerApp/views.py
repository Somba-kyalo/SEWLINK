...
def dashboard(request):
    ...
    return render(request, 'CustomerApp/customer_dashboard.html', {'customer': customer, 'active_jobs': active_jobs, 'completed_jobs': completed_jobs, 'recent_jobs': recent_jobs})
...
def tailor_search(request):
    ...
    if query:
        tailors = tailors.filter(models.Q(business_name__icontains=query) | models.Q(full_name__icontains=query) | models.Q(location__icontains=query))
